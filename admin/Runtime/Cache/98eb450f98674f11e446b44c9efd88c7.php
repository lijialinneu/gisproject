...
<!-- link rel="stylesheet" href="__PUBLIC__/Css/admin/form.css" type="text/css" media="screen" /-->
  ...
  <div id="sidebar">
    <div id="sidebar-wrapper">
	    ...
	    <ul id="main-nav">
			...
			<li> 
				<a href="#" class="nav-top-item current">用户信息管理中心</a>
				<ul>
		            <li><a href="#" class="current">管理用户信息</a></li>
		        </ul>
	        </li>
	     </ul>
    </div>
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">用户列表(共<?php echo ($news_count); ?>人)</a></li>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <div class="notification attention png_bg"> <a href="#" class="close"><img src="__PUBLIC__/Images/admin/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
            <div>您好，<?php echo ($adminname); ?>，您可以在下面管理用户信息！ </div>
          </div>
          ...
          <table>
            ...
            <tbody>
              <?php if(is_array($users_list)): $i = 0; $__LIST__ = $users_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="#" title="修改"><img src="__PUBLIC__/Images/admin/icons/pencil.png" alt="修改" /></a> 
